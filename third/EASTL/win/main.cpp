...
void* user_alloctor(size_t size)
{
	return hc::IMemorySystem::AllocMemory(size);
}
void user_free(void* ptr)
{
	hc::IMemorySystem::ReleaseMemory(ptr);
}
...
static_assert(sizeof(uint16_t) == EA_WCHAR_SIZE, "wchar_t should be 2 bytes long.");
