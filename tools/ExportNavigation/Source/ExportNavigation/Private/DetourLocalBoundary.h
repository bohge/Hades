...
#ifndef ORIGINAL_DETOURLOCALBOUNDARY_H
#define ORIGINAL_DETOURLOCALBOUNDARY_H
...
namespace original
{
	class dtLocalBoundary
	{
		...
		odtPolyRef m_polys[MAX_LOCAL_POLYS];
		int m_npolys;
	...
	public:
		...
		void update(odtPolyRef ref, const float* pos, const float collisionQueryRange,
