...
ifeq ($(config),debug)
  ...
  TARGET = $(TARGETDIR)/base64.so
  OBJDIR = obj/Debug/lbase64
  DEFINES += -DDEBUG
...
$(OBJDIR)/lbase64.o: ../../third/lbase64/lbase64.c
	@echo $(notdir $<)
