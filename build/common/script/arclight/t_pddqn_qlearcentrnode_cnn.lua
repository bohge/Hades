...
local synchronize_step = 40000; --没过多少step同步
local switch_frequency = 10000; --目标网络与训练网络切换频率 
...
function qlearcentrnode:Setup()
  if _ENABLE_TENSOR_BOARD then
    ...
    self.cc:remove_experiment("dpddqn_cnn");
    self.tensorboard = self.cc:create_experiment("dpddqn_cnn");
  end
