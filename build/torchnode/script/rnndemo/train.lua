...
require 'nngraph'
require 'optim'
local CharLMMinibatchLoader = require 'rnndemo.data.CharLMMinibatchLoader'
local LSTM = require 'rnndemo.LSTM'             -- LSTM timestep and utilities
require 'rnndemo.Embedding'                     -- class name is Embedding (not namespaced)
local model_utils=require 'rnndemo.model_utils'

function lstmtrain(opt)
