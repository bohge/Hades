...
function EntryScene:OnRequest(room)
  
  local EnterSceneInfo = Utility_CapnpDecoder( msg_capn.MsgEntrySceneRequest, buffer );  
  local Player = room:AddPlayer();    
